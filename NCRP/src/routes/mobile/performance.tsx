...
import { formatNumber, monthlySeries, stateRows, mobileTiles } from "@/lib/telecom";
import { Gauge, Timer, TrendingUp } from "lucide-react";

export const Route = createFileRoute("/mobile/performance")({
  head: () => ({
    meta: [
      { title: "Mobile Number Performance Report | NCRP Telecom Intelligence" },
      { name: "description", content: "Blocking turnaround, effectiveness and monthly growth for suspect mobile numbers." },
      { property: "og:title", content: "Mobile Number Performance Report | NCRP Telecom Intelligence" },
      { property: "og:description", content: "Blocking turnaround, effectiveness and monthly growth for suspect mobile numbers." },
    ],
  }),
...
function MobilePerformance() {
  ...
  return (
    <>
      <PageHeader
        title="Mobile Number Performance Report"
        description="Blocking turnaround, effectiveness and monthly growth for suspect mobile numbers."
        crumbs={[{ label: "Telecom Module" }, { label: "Mobile Number" }, { label: "Performance Report" }]}
      ...
      <div className="mb-6 grid gap-4 xl:grid-cols-2">
        <Panel className="overflow-hidden">
          ...
          <TrendLine data={monthlySeries("MobilePerformance", mobileTiles[0].value)} keys={[
